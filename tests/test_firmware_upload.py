...
class TestFirmwareUpload:
    ...
    def test_upload_firmware(self):
        ...
        self.firmware_upload_page.device_update(Config.FIRMWARE_FILE_PATH) # The file path should be absolute and point to a valid firmware file for the test to work
